...
public partial class User
{
    ...
    public virtual ICollection<User> InverseDeleterUser { get; set; } = new List<User>();

    public virtual ICollection<Permission> Permissions { get; set; } = new List<Permission>();

    public virtual ICollection<Setting> Settings { get; set; } = new List<Setting>();

    public virtual ICollection<Tenant> TenantCreatorUsers { get; set; } = new List<Tenant>();

    public virtual ICollection<Tenant> TenantDeleterUsers { get; set; } = new List<Tenant>();

    public virtual ICollection<Tenant> TenantLastModifierUsers { get; set; } = new List<Tenant>();
