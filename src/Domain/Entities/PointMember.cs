...
public partial class PointMember
{
    ...
    public virtual PointMemberLoyaltyInfo? MemberLoyaltyInfo { get; set; }
    ...
    public virtual ICollection<PointSpecialSettingHistory> PointSpecialSettingHistories { get; set; } = new List<PointSpecialSettingHistory>();
}
